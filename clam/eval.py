...
parser.add_argument('--save_exp_code', type=str, default='ais',
                    help='experiment code to save eval results')
parser.add_argument('--models_exp_code', type=str, default='combine/task_1_tumor_vs_normal_CLAM_50_ais_s1',
...
if args.task == 'task_1_tumor_vs_normal':
    args.n_classes=2
    dataset = Combine_MIL_Dataset(
        data_dir=r'D:\project\SLFCD\dataset\combine',
        mode="test",
        shuffle=False,
        seed=1,
        print_info=True,
...
if __name__ == "__main__":
    ...
    for ckpt_idx in range(len(ckpt_paths)):
        ...
        print("save_fold_path: ", os.path.join(args.save_dir, 'fold_{}.csv'.format(folds[ckpt_idx])))
    ...
    print("save_eval_summary_path: ", os.path.join(args.save_dir, save_name))

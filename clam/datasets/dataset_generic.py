...
class Generic_WSI_Classification_Dataset(Dataset):
    def __init__(self, csv_path='dataset_csv/ccrcc_clean.csv', shuffle=False, seed=7, print_info=True,
                 label_dict={}, filter_dict={}, ignore=[], patient_strat=False, label_col=None, patient_voting='max'):
        """
        Args:
...
class Combine_MIL_Dataset(Generic_WSI_Classification_Dataset):
    ...
    def __init__(self, data_dir, mode="train", shuffle=False, seed=7, print_info=True, patient_strat=False,
                 label_col=None, patient_voting='max', type='hsil', **kwargs):
